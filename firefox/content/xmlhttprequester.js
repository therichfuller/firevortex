function firevortex_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
firevortex_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				firevortex_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
firevortex_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
firevortex_xmlhttpRequester.prototype.setupRequestEvent =
